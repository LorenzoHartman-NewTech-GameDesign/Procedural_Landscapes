...
namespace GlobalSnowEffect
{
    ...
    public class GlobalSnowEditor : Editor
    {
        ...
        SerializedProperty defaultExclusionLayer, coverageMask, coverageMaskTexture, coverageMaskWorldSize, coverageMaskWorldCenter, groundCoverage, coverageUpdateMethod;
        ...
        SerializedProperty characterController, footprints, footprintsDuration, footprintsAutoFPS, footprintsScale, footprintsObscurance;
        SerializedProperty terrainMarks, terrainMarksDuration, terrainMarksDefaultSize, terrainMarksAutoFPS, terrainMarksViewDistance;
        SerializedProperty snowfall, snowfallIntensity, snowfallUseIllumination, snowfallReceiveShadows, cameraFrost, cameraFrostIntensity, cameraFrostSpread;
        SerializedProperty terrainMarksTextureSize, updateSpeedTree, speedTreeRemoveLeaves, opaqueCutout, billboardCoverage, grassCoverage, fixMaterials;
        SerializedProperty enableHotKeys;
        SerializedProperty forceForwardRenderingPath, floatingPointNormalsBuffer,  smoothness, snowAmount, altitudeBlending, enableWMAPI;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (expandSection[SCENE_SETTINGS])
            {
                ...
                if (!deferred || gs.forceForwardRenderingPath)
                {
                    ...
                    EditorGUILayout.HelpBox("Please check the documentation or contact us (by email at contact@kronnect.me or using our support forum on kronnect.com) if you find any issue with custom shaders or objects being clipped by snow rendering.", MessageType.Info);
                }
            }
        ...
        private void FillMaskTexture(byte value)
        {
